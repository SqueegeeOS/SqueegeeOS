...
export default async function TechnicianReferralPage() {
  ...
  return (
    <main className="mx-auto min-h-[100svh] max-w-lg px-4 pb-32 pt-8 sm:px-6">
      <header>
        <p className="text-[10px] uppercase tracking-[0.22em] text-accent">HomeAtlas · Crew</p>
        <h1 className="mt-3 font-serif text-4xl font-light tracking-[-0.04em] text-foreground">Send HQ a warm lead.</h1>
