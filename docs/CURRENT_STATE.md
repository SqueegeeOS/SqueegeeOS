...
| Production database state | **Unverified locally** | Repository contains migrations 002–038; applied-production ledger is not yet proven |
...
2. Run the read-only migration ledger and compare migrations 002–038 with production; do not apply 036–038 until their disposable rehearsals and named prerequisites pass.
