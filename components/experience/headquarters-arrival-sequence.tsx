...
import { headquartersWelcomeLine } from "@/lib/motion/boot-sequence";
...
export function HeadquartersArrivalSequence({
  ...
  useEffect(() => {
    ...
    const completeTimer = setTimeout(finish, previewMode ? 3600 : 3600);
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(201,184,150,0.07),transparent_55%)]"
      />
