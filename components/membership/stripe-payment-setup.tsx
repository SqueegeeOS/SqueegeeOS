      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        {onBack ? (
          <button
            ...
            className={
              isPresentation
                ? "rounded-lg border border-white/15 px-5 py-3.5 text-sm text-white/60 transition hover:border-white/30 hover:text-white/80 disabled:opacity-40 portal-payment-back-button"
...
export function StripePaymentSetup(props: StripePaymentSetupProps) {
  ...
  if (!clientSecret || !stripePromise) {
    return (
      <p className="text-sm text-white/50 portal-payment-loading">
