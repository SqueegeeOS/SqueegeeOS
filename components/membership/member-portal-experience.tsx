    ...
    >
      <div className="mx-auto max-w-2xl px-5 pb-[max(3rem,env(safe-area-inset-bottom))] pt-[max(3.5rem,env(safe-area-inset-top))] sm:px-10 sm:pb-20 sm:pt-16">
        ...
        >
          ...
          {view.pendingPayment && (
            <p className="mt-6 inline-flex rounded-full border border-amber-400/30 bg-amber-500/10 px-4 py-2 text-[11px] uppercase tracking-[0.16em] text-amber-100/90 portal-pending-payment-badge">
              Almost there
            </p>
          )}
        </motion.header>
