  ...
  if (variant === "card") {
    return (
      <div className="founding-honor-card space-y-1">
        <p className="founding-honor-card-title text-[9px] font-medium uppercase tracking-[0.2em] text-amber-200/90">
          <span className="font-serif normal-case tracking-normal text-amber-300/95">
            ✦{" "}
          </span>
          {display.title}
        </p>
        <p className="founding-honor-card-story text-[10px] leading-snug text-white/55">
          {display.story}
        </p>
        <p className="founding-honor-card-since text-[9px] uppercase tracking-[0.16em] text-amber-100/75">
