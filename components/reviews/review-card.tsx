  ...
  return (
    <blockquote className="text-center">
      ...
      <footer className="mt-8 flex flex-col items-center gap-3">
        <ReviewerAvatar name={review.reviewerName} photoUrl={review.profilePhotoUrl} />
        <div>
          ...
          <p className="mt-1 text-[10px] uppercase tracking-[0.28em] text-muted">
            ...
            {formatReviewDate(review.reviewDate)} · {review.source}
          </p>
        </div>
      </footer>
    </blockquote>
...
export function buildReviewsTitle(data: ReviewsData): string {
  return `${data.totalCount}+ Five-Star Reviews`;
}
